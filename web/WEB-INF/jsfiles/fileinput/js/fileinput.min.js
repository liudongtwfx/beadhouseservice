...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var r, o, l, s, d, c, u, p = "init_" + a, f = i.previewCache.data, m = f.config[a],
                        v = f.content[a], g = i.previewInitId + "-" + p,
                    ...
                    var o, l = r.config[e], s = t.ifSet("caption", l), d = t.ifSet("width", l, "auto"),
                        c = t.ifSet("url", l, !1), u = t.ifSet("key", l, null), p = i.fileActionSettings,
                        f = i.initialPreviewShowDelete || !1, m = l.downloadUrl || i.initialPreviewDownloadUrl || "",
                        v = l.filename || l.caption || "", g = !!m,
                        h = t.ifSet("showDelete", l, t.ifSet("showDelete", p, f)),
                        w = t.ifSet("showDownload", l, t.ifSet("showDownload", p, g)),
                        _ = t.ifSet("showZoom", l, t.ifSet("showZoom", p, !0)),
                        b = t.ifSet("showDrag", l, t.ifSet("showDrag", p, !0)), C = c === !1 && a;
                    return w = w && l.downloadUrl !== !1 && !!m, o = i._renderFileActions(!1, w, h, _, b, C, c, u, !0, m, v), i._getLayoutTemplate("footer").setTokens({
            ...
            var i, a = this, n = a.$errorContainer;
            e && (i = a.msgFoldersNotAllowed.replace("{n}", e), a._addError(i), t.addCss(a.$container, "has-error"), n.fadeIn(800), a._raise("filefoldererror", [e, i]))
        }, _showUploadError: function (e, i, a) {
            var n = this, r = n.$errorContainer, o = a || "fileuploaderror",
                l = i && i.id ? '<li data-file-id="' + i.id + '">' + e + "</li>" : "<li>" + e + "</li>";
            return 0 === r.find("ul").length ? n._addError("<ul>" + l + "</ul>") : r.find("ul").append(l), r.fadeIn(800), n._raise(o, [i, e]), n.$container.removeClass("file-input-new"), t.addCss(n.$container, "has-error"), !0
        }, _showError: function (e, i, a) {
            var n = this, r = n.$errorContainer, o = a || "fileerror";
            return i = i || {}, i.reader = n.reader, n._addError(e), r.fadeIn(800), n._raise(o, [i, e]), n.isAjaxUpload || n._clearFileInput(), n.$container.removeClass("file-input-new"), t.addCss(n.$container, "has-error"), n.$btnUpload.attr("disabled", !0), !0
        }, _noFilesError: function (e) {
            var i = this, a = i.minFileCount > 1 ? i.filePlural : i.fileSingle,
                n = i.msgFilesTooLess.replace("{n}", i.minFileCount).replace("{files}", a), r = i.$errorContainer;
            i._addError(n), i.isError = !0, i._updateFileDetails(0), r.fadeIn(800), i._raise("fileerror", [e, n]), i._clearFileInput(), t.addCss(i.$container, "has-error")
            ...
            var i, a, n, r, o = this, l = o.allowedPreviewTypes || [];
            for (r = 0; r < l.length; r++) if (n = l[r], i = o.fileTypeSettings[n], a = i(e.type, e.name) ? n : "", !t.isEmpty(a)) return a;
            return "other"
            ...
            var n, r, o, l, s, d, c, u, p, f, m, v = this, g = v.getFileStack().length, h = new FormData,
            ...
            }, h.append(v.uploadFileAttr, v.filestack[i], v.filenames[i]), h.append("file_id", i), v._ajaxSubmit(c, u, p, f, w, i))
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function () {
                var n, r, o, l, s = e(this), d = s.closest(t.FRAMES), c = d.attr("id"), u = d.attr("data-fileindex");
                i._handler(s, "click", function () {
                    return l = i._raise("filepreremove", [c, u]), l !== !1 && i._validateMinCount() ? (n = d.hasClass("file-preview-error"), t.cleanMemory(d), void d.fadeOut("slow", function () {
                        t.cleanZoomCache(a.find("#zoom-" + c)), i.updateStack(u, void 0), i._clearObjects(d), d.remove(), c && n && i.$errorContainer.find('li[data-file-id="' + c + '"]').fadeOut("fast", function () {
                            e(this).remove(), i._errorsExist() || i._resetErrors()
                        }), i._clearFileInput();
                        var l = i.getFileStack(!0), s = i.previewCache.count(), p = l.length,
                            f = i.showPreview && i.getFrames().length;
                        0 !== p || 0 !== s || f ? (r = s + p, o = r > 1 ? i._getMsgSelected(r) : l[0] ? i._getFileNames()[0] : "", i._setCaption(o)) : i.reset(), i._raise("fileremoved", [c, u])
                    })) : !1
                })
            ...
            i._initZoomButton(), a.find(r).each(function () {
                var r, o, c, u = e(this), p = u.data("url") || i.deleteUrl, f = u.data("key");
                u.closest(".file-preview-frame");
                if (!t.isEmpty(p) && void 0 !== f) {
                    var m, v, g, h, w = u.closest(t.FRAMES), _ = i.previewCache.data, b = w.attr("data-fileindex");
                    b = parseInt(b.replace("init_", "")), g = t.isEmpty(_.config) && t.isEmpty(_.config[b]) ? null : _.config[b], h = t.isEmpty(g) || t.isEmpty(g.extra) ? n : g.extra, "function" == typeof h && (h = h()), v = {
                        ...
                        i.ajaxAborted = !1, i._raise("filepredelete", [f, e, h]), u.removeClass(s), i._abort() ? e.abort() : (t.addCss(w, "file-uploading"), t.addCss(u, "disabled " + l))
                    }, o = function (e, n, r) {
                        var o, c;
                        ...
                        })) : (v.jqXHR = r, v.response = e, i._showError(e.error, v, "filedeleteerror"), w.removeClass("file-uploading"), u.removeClass("disabled " + l).addClass(s), void d())
                    }, c = function (e, t, a) {
                        var n = i.ajaxOperations.deleteThumb, r = i._parseError(n, e, a);
                        v.jqXHR = e, v.response = {}, i._showError(r, v, "filedeleteerror"), w.removeClass("file-uploading"), u.removeClass("disabled " + l).addClass(s), d()
                    ...
                    }, i.ajaxDeleteSettings), i._handler(u, "click", function () {
        ...
        }, _generatePreviewTemplate: function (i, a, n, r, o, l, s, d, c, u, p) {
            ...
            }, u = u || o.slice(o.lastIndexOf("-") + 1), v.fileActionSettings.showZoom && (h = m(E ? "other" : i, a, !0, "kv-zoom-thumb")), h = "\n" + v._getLayoutTemplate("zoomCache").replace("{zoomContent}", h), f = m(T ? "other" : i, a, !1, "kv-preview-thumb"), f + h
        }, _previewDefault: function (i, a, n) {
            var r = this, o = r.$preview;
            if (r.showPreview) {
                var l, s = i ? i.name : "", d = i ? i.type : "", c = i.size || 0, u = r.slug(s),
                    p = n === !0 && !r.isAjaxUpload, f = t.objUrl.createObjectURL(i);
        ...
        }, _previewFile: function (e, i, a, n, r) {
            if (this.showPreview) {
                var o, l = this, s = l._parseFileType(i), d = i ? i.name : "", c = l.slug(d), u = l.allowedPreviewTypes,
                    p = l.allowedPreviewMimeTypes, f = l.$preview, m = u && u.indexOf(s) >= 0, v = i.size || 0,
                    g = i.type, h = "text" === s || "html" === s || "image" === s ? a.target.result : r,
                    w = p && -1 !== p.indexOf(g);
                if ("html" === s && l.purifyHtml && window.DOMPurify && (h = window.DOMPurify.sanitize(h)), m || w) {
                    o = l._generatePreviewTemplate(s, h, d, g, n, !1, v), l._clearDefaultPreview(), f.append("\n" + o);
                    var _ = f.find("#" + n + " img");
                    _.length && l.autoOrientImage ? t.validateOrientation(i, function (e) {
                        if (!e) return void l._validateImage(n, c, g, v, h);
                        var a = f.find("#zoom-" + n + " img"), r = "rotate-" + e;
                        e > 4 && (r += _.width() > _.height() ? " is-portrait-gt4" : " is-landscape-gt4"), t.addCss(_, r), t.addCss(a, r), l._raise("fileimageoriented", {
                            $img: _,
                            file: i
                        }), l._validateImage(n, c, g, v, h), t.adjustOrientedImage(_)
                    }) : l._validateImage(n, c, g, v, h)
                } else l._previewDefault(i, n);
            ...
            var a, n = this, r = n.$element, o = n.$preview, l = n.reader, s = n.$previewContainer,
                d = n.$previewStatus, c = n.msgLoading, u = n.msgProgress, p = n.previewInitId, f = i.length,
            ...
            n.loadedImages = [], n.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                if (t.isEmpty(r.attr("multiple")) && (f = 1), e >= f) return n.isAjaxUpload && n.filestack.length > 0 ? n._raise("filebatchselected", [n.getFileStack()]) : n._raise("filebatchselected", [i]), s.removeClass("file-thumb-loading"), void d.html("");
                var x, T, E, S, k, F, I, P, A, z, D = v + e, $ = p + "-" + D, j = i[e],
                    U = j.name ? n.slug(j.name) : "", B = (j.size || 0) / 1e3, R = "", O = t.objUrl.createObjectURL(j),
                    L = 0, Z = "";
                if (h > 0) for (S = 0; h > S; S++) P = g[S], A = n.msgFileTypes[P] || P, Z += 0 === S ? A : ", " + A;
                if (U === !1) return void a(e + 1);
                if (0 === U.length) return k = n.msgInvalidFileName.replace("{name}", t.htmlEncode(j.name)), void y(k, j, $, e);
                if (t.isEmpty(w) || (R = new RegExp("\\.(" + w.join("|") + ")$", "i")), E = B.toFixed(2), n.maxFileSize > 0 && B > n.maxFileSize) return k = n.msgSizeTooLarge.setTokens({
                    name: U,
                    size: E,
                    maxSize: n.maxFileSize
                }), void y(k, j, $, e);
                if (null !== n.minFileSize && B <= t.getNum(n.minFileSize)) return k = n.msgSizeTooSmall.setTokens({
                    name: U,
                    size: E,
                    minSize: n.minFileSize
                }), void y(k, j, $, e);
                if (!t.isEmpty(g) && t.isArray(g)) {
                    for (S = 0; S < g.length; S += 1) F = g[S], z = m[F], L += z && "function" == typeof z && z(j.type, j.name) ? 1 : 0;
                    if (0 === L) return k = n.msgInvalidFileType.setTokens({name: U, types: Z}), void y(k, j, $, e)
                }
                return 0 !== L || t.isEmpty(w) || !t.isArray(w) || t.isEmpty(R) || (I = t.compare(U, R), L += t.isEmpty(I) ? 0 : I.length, 0 !== L) ? n.showPreview ? !C && B > b ? (n.addToStack(j), s.addClass("file-thumb-loading"), n._previewDefault(j, $), n._initFileActions(), n._updateFileDetails(f), void a(e + 1)) : (o.length && void 0 !== FileReader ? (d.html(c.replace("{index}", e + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                    ...
                    n._previewFile(e, j, t, $, O), n._initFileActions()
                }, l.onloadend = function () {
                    k = u.setTokens({index: e + 1, files: f, percent: 50, name: U}), setTimeout(function () {
                        d.html(k), n._updateFileDetails(f), a(e + 1)
                    }, 100), n._raise("fileloaded", [j, $, e, l])
                }, l.onprogress = function (t) {
                    if (t.lengthComputable) {
                        var i = t.loaded / t.total * 100, a = Math.ceil(i);
                        k = u.setTokens({index: e + 1, files: f, percent: a, name: U}), setTimeout(function () {
                            d.html(k)
                        }, 100)
                    }
                }, x = m.text, T = m.image, x(j.type, U) ? l.readAsText(j, n.textEncoding) : T(j.type, U) ? l.readAsDataURL(j) : l.readAsArrayBuffer(j)) : (n._previewDefault(j, $), setTimeout(function () {
                    a(e + 1), n._updateFileDetails(f)
                }, 100), n._raise("fileloaded", [j, $, e, l])), void n.addToStack(j)) : (n.isAjaxUpload && n.addToStack(j), setTimeout(function () {
                    a(e + 1), n._updateFileDetails(f)
                }, 100), void n._raise("fileloaded", [j, $, e, l])) : (k = n.msgInvalidFileExtension.setTokens({
                    name: U,
                    extensions: _
                }), void y(k, j, $, e))
            ...
            i.isError ? (i.$previewContainer.removeClass("file-thumb-loading"), i.$previewStatus.html(""), i.$captionContainer.find(".kv-caption-icon").hide()) : i._showFileIcon(), i._setCaption(d, i.isError), i.$container.removeClass("file-input-new file-input-ajax-new"), 1 === arguments.length && i._raise("fileselect", [e, o]), i.previewCache.count() && i._initPreviewActions()
            ...
            var n = this;
            return void 0 !== t && n.updateStack(t, i), n.removeFromPreviewOnError && !a ? void e.remove() : (n._setThumbStatus(e, "Error"), void n._refreshUploadButton(e, a))
            ...
            var s, d, c, u, p = this, f = "Small" === i ? "min" : "max", m = p[f + "Image" + o];
            !t.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === i ? d >= m : m >= d, u || (s = p["msgImage" + o + i].setTokens({
                name: r,
                size: m
            }), p._showUploadError(s, l), p._setPreviewError(n, e, null)))
        }, _validateImage: function (t, i, a, n, r) {
            var o, l, s, d, c = this, u = c.$preview, p = u.find("#" + t), f = p.attr("data-fileindex"),
                m = p.find("img");
            i = i || "Untitled", m.one("load", function () {
                l = p.width(), s = u.width(), l > s && m.css("width", "100%"), o = {
                    ind: f,
                    id: t
                }, c._checkDimensions(f, "Small", m, p, i, "Width", o), c._checkDimensions(f, "Small", m, p, i, "Height", o), c.resizeImage || (c._checkDimensions(f, "Large", m, p, i, "Width", o), c._checkDimensions(f, "Large", m, p, i, "Height", o)), c._raise("fileimageloaded", [t]), d = window.piexif ? window.piexif.load(r) : null, c.loadedImages.push({
                    ind: f,
                    img: m,
                    thumb: p,
                    pid: t,
            ...
            var r, o, l, s, d, c, u, p = this, f = e(i.img)[0], m = f.naturalWidth, v = f.naturalHeight, g = 1,
                h = p.maxImageWidth || m, w = p.maxImageHeight || v, _ = !(!m || !v), b = p.imageCanvas,
                C = p.imageCanvasContext, y = i.typ, x = i.pid, T = i.ind, E = i.thumb, S = i.exifObj;
            if (d = function (e, t, i) {
                    p.isAjaxUpload ? p._showUploadError(e, t, i) : p._showError(e, t, i), p._setPreviewError(E, T)
                }, (!p.filestack[T] || !_ || h >= m && w >= v) && (_ && p.filestack[T] && p._raise("fileimageresized", [x, T]), a.val++, a.val === n && p._raise("fileimagesresized"), !_)) return void d(p.msgImageResizeError, {
                id: x,
                index: T
            }, "fileimageresizeerror");
            y = y || p.resizeDefaultImageType, o = m > h, l = v > w, g = "width" === p.resizePreference ? o ? h / m : l ? w / v : 1 : l ? w / v : o ? h / m : 1, p._resetCanvas(), m *= g, v *= g, b.width = m, b.height = v;
            try {
                C.drawImage(f, 0, 0, m, v), s = b.toDataURL(y, p.resizeQuality), S && (u = window.piexif.dump(S), s = window.piexif.insert(u, s)), r = t.dataURI2Blob(s), p.filestack[T] = r, p._raise("fileimageresized", [x, T]), a.val++, a.val === n && p._raise("fileimagesresized", [void 0, void 0]), r instanceof Blob || d(p.msgImageResizeError, {
                    id: x,
                    index: T
                }, "fileimageresizeerror")
            } catch (k) {
                a.val++, a.val === n && p._raise("fileimagesresized", [void 0, void 0]), c = p.msgImageResizeException.replace("{errors}", k.message), d(c, {
                    id: x,
                    index: T
            ...
            return e.overwriteInitial || t.isEmpty(i) ? (e.$caption.html(""), !1) : (e._setCaption(i), !0)
        }, _setCaption: function (i, a) {
            var n, r, o, l, s = this, d = s.getFileStack();
            if (s.$caption.length) {
                if (a) n = e("<div>" + s.msgValidationError + "</div>").text(), o = d.length, l = o ? 1 === o && d[0] ? s._getFileNames()[0] : s._getMsgSelected(o) : s._getMsgSelected(s.msgNo), r = '<span class="' + s.msgValidationErrorClass + '">' + s.msgValidationErrorIcon + (t.isEmpty(i) ? l : i) + "</span>"; else {
                    if (t.isEmpty(i)) return;
                    n = e("<div>" + i + "</div>").text(), r = s._getLayoutTemplate("fileIcon") + n
                }
            ...
            var r, o = this, l = o.fileActionSettings, s = l.showRemove, d = l.showDrag, c = l.showUpload,
                u = l.showZoom, p = o._getLayoutTemplate("footer"), f = o._getLayoutTemplate("indicator"),
            ...
            return i = o._getSize(i), r = o.isAjaxUpload ? p.setTokens({
                actions: o._renderFileActions(c, !1, s, u, d, !1, !1, !1),
                caption: e,
                size: i,
                width: a,
                ...
                actions: o._renderFileActions(!1, !1, !1, u, d, !1, !1, !1),
                caption: e,
                size: i,
                width: a,
                progress: "",
            ...
            if (!(e || t || i || a || n)) return "";
            var u, p = this, f = o === !1 ? "" : ' data-url="' + o + '"', m = l === !1 ? "" : ' data-key="' + l + '"',
                v = "", g = "", h = "", w = "", _ = "", b = p._getLayoutTemplate("actions"), C = p.fileActionSettings,
                y = p.otherActionButtons.setTokens({dataKey: m, key: l}),
                x = r ? C.removeClass + " disabled" : C.removeClass;
            return i && (v = p._getLayoutTemplate("actionDelete").setTokens({
                removeClass: x,
            ...
            })), t && (h = p._getLayoutTemplate("actionDownload").setTokens({
                ...
                filename: c,
                key: l
            })), a && (w = p._getLayoutTemplate("actionZoom").setTokens({
                zoomClass: C.zoomClass,
                zoomIcon: C.zoomIcon,
                zoomTitle: C.zoomTitle
            })), n && s && (u = "drag-handle-init " + C.dragClass, _ = p._getLayoutTemplate("actionDrag").setTokens({
                dragClass: u,
            ...
            var r, o, l, s, d = [], c = arguments.length > 1, u = a.isAjaxUpload,
                p = c ? i.originalEvent.dataTransfer.files : n.get(0).files, f = a.filestack.length,
                m = t.isEmpty(n.attr("multiple")), v = m && f > 0, g = 0, h = a._getFileIds(),
                w = function (t, i, n, r) {
                    var o = e.extend(!0, {}, a._getOutData({}, {}, p), {id: n, index: r}),
                        l = {id: n, index: r, file: i, files: p};
                    return a.isAjaxUpload ? a._showUploadError(t, o) : a._showError(t, l)
                };
            if (a.reader = null, a._resetUpload(), a._hideFileIcon(), a.isAjaxUpload && a.$container.find(".file-drop-zone ." + a.dropZoneTitleClass).remove(), c ? e.each(p, function (e, t) {
                    t && !t.type && void 0 !== t.size && t.size % 4096 === 0 ? g++ : a._filterDuplicate(t, d, h)
                }) : (p = i.target && void 0 === i.target.files ? i.target.value ? [{name: i.target.value.replace(/^.+\\/, "")}] : [] : i.target.files || {}, u ? e.each(p, function (e, t) {
                    a._filterDuplicate(t, d, h)
                }) : d = p), t.isEmpty(d) || 0 === d.length) return u || a.clear(), a._showFolderError(g), void a._raise("fileselectnone");
            ...
            i._getThumbs().each(function () {
                var l, s = e(this), d = s.attr("data-fileindex"), c = i.filestack[d], u = s.attr("id");
                "-1" !== d && -1 !== d && (void 0 !== c ? (n[a] = c, r[a] = i._getFileName(c), o[a] = i._getFileId(c), s.attr({
                    ...
                    id: l,
                    "data-fileindex": "-1"
                }), i.$preview.find("#zoom-" + u).attr("id", "zoom-" + l)))
        ...
        if (t.hasFileAPISupport() || t.isIE(9)) {
            ...
            switch (n.shift(), this.each(function () {
                ...
                s || (c && (p = e.fn.fileinputThemes[c] || {}), "en" === f || t.isEmpty(e.fn.fileinputLocales[f]) || (u = e.fn.fileinputLocales[f] || {}), o = e.extend(!0, {}, e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, l.data()), s = new i(this, o), l.data("fileinput", s)), "string" == typeof a && r.push(s[a].apply(s, n))
            }), r.length) {
                case 0:
                    return this;
                case 1:
