...
@ComponentScan(basePackages = "main.java.com.beadhouse", excludeFilters = @ComponentScan.Filter({Controller.class,
...
public class RootConfig implements AsyncConfigurer, SchedulingConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        factory.setPackagesToScan("main.java.com.beadhouse.model");
