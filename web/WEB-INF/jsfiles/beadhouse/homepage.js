/**
 * Created by liudong on 2017/2/28.
 */
$(document).ready(
    function () {
        $.get(
            ...
            function (data) {
                if (data == "") {
                    var newNode = '<a href="/admin/register">[点击注册]</a> <a href="/admin/login" >[点击登陆]</a>';
                    $("#register_login").html(newNode);
                } else {
                    $("#register_login").html("欢迎您：" + data + "<a href='javascript:void(0)' onclick='logout()'>注销</a>");
                }
            }
        )
