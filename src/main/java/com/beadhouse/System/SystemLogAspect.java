...
//    VipUserRepository vipUserRepository;
    ...
    //Controller层切点
    @Pointcut("execution(* main.java.com.beadhouse.controller.admin.AdminCarouselController.*(..))")
     ...
     * @param joinPoint 切点
     */
    @Before("execution(* main.java.com.beadhouse.controller.admin.AdminCarouselController.*(..))")
