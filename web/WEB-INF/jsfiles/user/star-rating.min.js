...
!function (t) {
    ...
    o.prototype = {
        constructor: o, _parseAttr: function (t, i) {
            ...
            t.$container.attr('id', "star_rating");
            ...
            return r(t.$captionElement) ? '<div class="caption">' + a + "</div>" : (t.$captionElement.removeClass("caption").addClass("caption").attr({title: t.clearCaption}), t.$captionElement.html(a), "")
        }, fetchCaption: function (t) {
            var e = this, a = parseFloat(t),
                n = r(e.starCaptionClasses[a]) ? e.clearCaptionClass : e.starCaptionClasses[a],
                l = r(e.starCaptions[a]) ? e.defaultCaption.replace(/\{rating\}/g, a) : e.starCaptions[a],
                i = a == e.clearValue ? e.clearCaption : l;
            ...
            var e = this, a = e.min, n = e.max,
                l = (e.step, arguments.length ? e.getValueFromPosition(t) : r(e.$element.val()) ? 0 : e.$element.val()),
                i = 0, s = (e.$rating.width(), e.fetchCaption(l));
