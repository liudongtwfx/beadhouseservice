...
if (!dojo._hasResource["dojox.color.Colorspace"]) {
    ...
    dojox.color.Colorspace = new (function () {
        ...
        var _6 = {
            "XYZ scaling": {ma: [[1, 0, 0], [0, 1, 0], [0, 0, 1]], mai: [[1, 0, 0], [0, 1, 0], [0, 0, 1]]},
            "Bradford": {
        ...
        var _7 = {
            "XYZ": {
                ...
                "XYZ": function (lab, _13) {
                    ...
                    var L = lab.L, C = Math.pow(lab.a * lab.a + lab.b * lab.b, 0.5),
                        H = Math.atan(lab.b, lab.a) * (180 / Math.PI);
                    if (H < 0) {
                        H += 360;
                    }
                    if (H < 360) {
                ...
                "Lab": function (lch) {
                    var _18 = lch.H * (Math.PI / 180), L = lch.L,
                        a = lch.C / Math.pow(Math.pow(Math.tan(_18), 2) + 1, 0.5);
                ...
                "XYZ": function (Luv, _19) {
                    ...
                    var L = Luv.L, C = Math.pow(Luv.u * Luv.u + Luv.v * Luv * v, 0.5),
                        H = Math.atan(Luv.v, Luv.u) * (180 / Math.PI);
                    if (H < 0) {
                        H += 360;
                    }
                    if (H > 360) {
        ...
        this.primaries = function (_91) {
            ...
            if (_91.whitepoint != _92.whitepoint) {
                var r = this.convert(this.adapt({
                    ...
                    adaptor: _91.adaptor,
                    source: _92.whitepoint,
                    destination: _91.whitepoint
                }), "XYZ", "xyY");
